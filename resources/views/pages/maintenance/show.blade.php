...
@section('content')
    ...
    'informacao3' => date('d-m-Y', strtotime($maintenance->date_entry)),
    'titulo4' => 'Data de Saida',
    'informacao4' => $maintenance->date_exit == "0000-00-00" ? "00-00-0000" : date('d-m-Y', strtotime($maintenance->date_exit)),
    'id' => $maintenance->id,
